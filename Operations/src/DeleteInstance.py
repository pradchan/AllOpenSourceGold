...
for vm in vms:
    if instancePrefix+'-instance' in vm['name']:
        instance = vm['name']
        break;
        
SSHKey='/Compute-'+authDomain+'/'+username+'/cloudnative.pub'
ipReservation='/Compute-'+authDomain+'/'+username+'/'+instancePrefix +'-IPReservation'
securityList='/Compute-'+authDomain+'/'+username+'/'+instancePrefix +'-SecurityList'
securityApplication='/Compute-'+authDomain+'/'+username+'/'+instancePrefix +'-MySQL-securityApplication'
securityRule1='/Compute-'+authDomain+'/'+username+'/'+instancePrefix +'-SSHRule'
securityRule2='/Compute-'+authDomain+'/'+username+'/'+instancePrefix +'-MySQLRule'
storageVolume='/Compute-'+authDomain+'/'+username+'/'+instancePrefix +'-storageVolume'
