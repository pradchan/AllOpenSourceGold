...
simpleResourceName = occ.buildResourceName('cloudnative.pub')
fullResourceName = None
SSHKey = occ.getSSHKeys(sshKeyName=simpleResourceName)

if len(SSHKey) == 0:
    with open('Operations/src/cloudnative.pub', 'rt') as keyFile:
...
simpleResourceName = occ.buildResourceName(instancePrefix+'-storageVolume')
fullResourceName = None
...
simpleResourceName = occ.buildResourceName(instancePrefix+'-IPReservation')
fullResourceName = None
...
simpleResourceName = occ.buildResourceName(instancePrefix+'-SecurityList')
fullResourceName = None
...
simpleResourceName = occ.buildResourceName(instancePrefix+'-instance')
fullResourceName = None
...
launchPlanMsgBody = { 'instances': [ { 'shape': 'oc3',
                                       ...
                                       'hostname': '',
                                       'reverse_dns': True,
                                       'label': 'This is a '+instancePrefix+' instance.',
...
simpleResourceName = occ.buildResourceName(instancePrefix+'-SSHRule')
fullResourceName = None
...
simpleResourceName = occ.buildResourceName(instancePrefix + '-MySQL-securityApplication')
fullResourceName = None
...
resourceTypeName = 'securityRule'
simpleResourceName = occ.buildResourceName(instancePrefix+'-MySQLRule')
fullResourceName = None
securityRule = occ.getSecurityRules(securityRuleName=simpleResourceName)
...
with open(instancePrefix + '-ResourceNames.json', 'wt') as nameFile:
