...
public interface EmployeesDAO {
	...
	@SqlUpdate("insert into employees (employee_id, first_name, last_name, email, phone_no, hire_date, salary) values (:employeeid, :firstname, :lastname, :email, :phoneno, DATE_FORMAT(:hiredate, '%Y-%m-%d'), :salary)")
	int insert(@Bind("employeeid") String employeeid, @Bind("firstname") String firstname, @Bind("lastname") String lastname, @Bind("email") String email, @Bind("phoneno") String phoneno, @Bind("hiredate") String hiredate, @Bind("salary") String salary);
