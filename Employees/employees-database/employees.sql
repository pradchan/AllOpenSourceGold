...
create table employees (employee_id INT UNSIGNED NOT NULL AUTO_INCREMENT = 100, first_name VARCHAR(50), last_name VARCHAR(50), email VARCHAR(50), phone_no VARCHAR(20), hire_date DATE, salary DECIMAL(8,2), PRIMARY KEY ( employee_id ));
...
insert into employees (employee_id, first_name, last_name, email, phone_no, hire_date, salary) values (NULL, 'Rohan', 'Walia', 'roahn.walia@abc.com', '7848078480', '2008-11-15', 34000.0);
