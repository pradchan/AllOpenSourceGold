...
create table employees (employee_id VARCHAR(50), first_name VARCHAR(50), last_name VARCHAR(50), email VARCHAR(50), phone_no VARCHAR(20), hire_date DATE, salary DECIMAL(8,2), PRIMARY KEY ( employee_id ));
